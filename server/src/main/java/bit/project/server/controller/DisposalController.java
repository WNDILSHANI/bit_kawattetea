...
import bit.project.server.entity.Disposalgradebatch;
...
public class DisposalController{
    ...
    public ResourceLink add(@RequestBody Disposal disposal, HttpServletRequest request) throws InterruptedException {
        ...
        for(Disposalgradebatch disposalgradebatch : disposal.getDisposalgradebatchList()) disposalgradebatch.setDisposal(disposal);
