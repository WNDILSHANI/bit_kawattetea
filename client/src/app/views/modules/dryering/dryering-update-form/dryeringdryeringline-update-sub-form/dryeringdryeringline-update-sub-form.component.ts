...
@Component({
  selector: 'app-dryeringdryeringline-update-sub-form',
  templateUrl: './dryeringdryeringline-update-sub-form.component.html',
  styleUrls: ['./dryeringdryeringline-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DryeringdryeringlineUpdateSubFormComponent),
      multi: true
    }, {
...
export class DryeringdryeringlineUpdateSubFormComponent extends AbstractSubFormComponent<Dryeringdryeringline> implements OnInit{
