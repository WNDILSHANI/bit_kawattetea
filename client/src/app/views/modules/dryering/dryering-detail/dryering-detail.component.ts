...
@Component({
  selector: 'app-dryering-detail',
  templateUrl: './dryering-detail.component.html',
  styleUrls: ['./dryering-detail.component.scss']
})
export class DryeringDetailComponent extends AbstractComponent implements OnInit {
  ...
  async delete(): Promise<void>{
    const dialogRef = this.dialog.open(DeleteConfirmDialogComponent, {
      width: '300px',
      data: {message: this.dryering.code}
    });
    ...
    dialogRef.afterClosed().subscribe( async result => {
      ...
      try {
        await this.dryeringService.delete(this.selectedId);
