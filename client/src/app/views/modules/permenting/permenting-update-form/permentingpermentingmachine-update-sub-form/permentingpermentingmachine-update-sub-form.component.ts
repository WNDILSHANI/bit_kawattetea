...
@Component({
  selector: 'app-permentingpermentingmachine-update-sub-form',
  templateUrl: './permentingpermentingmachine-update-sub-form.component.html',
  styleUrls: ['./permentingpermentingmachine-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PermentingpermentingmachineUpdateSubFormComponent),
      multi: true
    }, {
...
export class PermentingpermentingmachineUpdateSubFormComponent extends AbstractSubFormComponent<Permentingpermentingmachine> implements OnInit{
