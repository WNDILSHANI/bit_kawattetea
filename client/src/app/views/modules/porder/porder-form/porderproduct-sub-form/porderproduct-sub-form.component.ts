...
@Component({
  selector: 'app-porderproduct-sub-form',
  templateUrl: './porderproduct-sub-form.component.html',
  styleUrls: ['./porderproduct-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PorderproductSubFormComponent),
      multi: true
    }, {
...
export class PorderproductSubFormComponent extends AbstractSubFormComponent<Porderproduct> implements OnInit{
