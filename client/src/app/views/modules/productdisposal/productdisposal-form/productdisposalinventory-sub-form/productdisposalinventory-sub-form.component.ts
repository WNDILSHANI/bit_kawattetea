...
@Component({
  selector: 'app-productdisposalinventory-sub-form',
  templateUrl: './productdisposalinventory-sub-form.component.html',
  styleUrls: ['./productdisposalinventory-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProductdisposalinventorySubFormComponent),
      multi: true
    }, {
...
export class ProductdisposalinventorySubFormComponent extends AbstractSubFormComponent<Productdisposalinventory> implements OnInit{
