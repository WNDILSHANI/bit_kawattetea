...
export class VehicleUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void{
    ...
    if (this.payloadwidthField.pristine) {
      this.payloadwidthField.setValue(this.vehicle.payloadwidth);
    }
    if (this.payloadlengthField.pristine) {
      this.payloadlengthField.setValue(this.vehicle.payloadlength);
    }
    if (this.payloadheightField.pristine) {
      this.payloadheightField.setValue(this.vehicle.payloadheight);
    }
  ...
  async submit(): Promise<void> {
    ...
    newvehicle.payloadwidth = this.payloadwidthField.value;
    newvehicle.payloadlength = this.payloadlengthField.value;
    newvehicle.payloadheight = this.payloadheightField.value;
