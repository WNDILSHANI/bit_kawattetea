...
@Component({
  selector: 'app-witheringwitherline-sub-form',
  templateUrl: './witheringwitherline-sub-form.component.html',
  styleUrls: ['./witheringwitherline-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => WitheringwitherlineSubFormComponent),
      multi: true
    }, {
...
export class WitheringwitherlineSubFormComponent extends AbstractSubFormComponent<Witheringwitherline> implements OnInit{
