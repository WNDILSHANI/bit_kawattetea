...
@Component({
  selector: 'app-grindinggrindingmachine-update-sub-form',
  templateUrl: './grindinggrindingmachine-update-sub-form.component.html',
  styleUrls: ['./grindinggrindingmachine-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => GrindinggrindingmachineUpdateSubFormComponent),
      multi: true
    }, {
...
export class GrindinggrindingmachineUpdateSubFormComponent extends AbstractSubFormComponent<Grindinggrindingmachine> implements OnInit{
