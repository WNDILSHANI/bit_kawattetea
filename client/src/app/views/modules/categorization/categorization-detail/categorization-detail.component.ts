...
@Component({
  selector: 'app-categorization-detail',
  templateUrl: './categorization-detail.component.html',
  styleUrls: ['./categorization-detail.component.scss']
})
export class CategorizationDetailComponent extends AbstractComponent implements OnInit {
  ...
  async delete(): Promise<void>{
    const dialogRef = this.dialog.open(DeleteConfirmDialogComponent, {
      width: '300px',
      data: {message: this.categorization.code}
    });
    ...
    dialogRef.afterClosed().subscribe( async result => {
      ...
      try {
        await this.categorizationService.delete(this.selectedId);
