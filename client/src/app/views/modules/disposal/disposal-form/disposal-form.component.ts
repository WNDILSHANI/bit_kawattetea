...
import {DisposalgradebatchSubFormComponent} from './disposalgradebatch-sub-form/disposalgradebatch-sub-form.component';
...
export class DisposalFormComponent extends AbstractComponent implements OnInit {
  ...
  @ViewChild(DisposalgradebatchSubFormComponent) disposalgradebatchSubForm: DisposalgradebatchSubFormComponent;
...
async loadData(): Promise<any>{
  ...
  async submit(): Promise<void> {
    this.disposalgradebatchSubForm.resetForm();
    ...
    disposal.disposalgradebatchList = this.disposalgradebatchesField.value;
    try{
