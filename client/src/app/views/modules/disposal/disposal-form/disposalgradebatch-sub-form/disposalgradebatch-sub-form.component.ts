...
@Component({
  selector: 'app-disposalgradebatch-sub-form',
  templateUrl: './disposalgradebatch-sub-form.component.html',
  styleUrls: ['./disposalgradebatch-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DisposalgradebatchSubFormComponent),
      multi: true
    }, {
...
export class DisposalgradebatchSubFormComponent extends AbstractSubFormComponent<Disposalgradebatch> implements OnInit{
