...
export class CollectionDetailComponent extends AbstractComponent implements OnInit {
  ...
  async delete(): Promise<void>{
    const dialogRef = this.dialog.open(DeleteConfirmDialogComponent, {
      width: '300px',
      data: {message: this.collection.code}
    });
    ...
    dialogRef.afterClosed().subscribe( async result => {
      ...
      try {
        await this.collectionService.delete(this.selectedId);
