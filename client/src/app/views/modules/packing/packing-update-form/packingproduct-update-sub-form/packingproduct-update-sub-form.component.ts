...
@Component({
  selector: 'app-packingproduct-update-sub-form',
  templateUrl: './packingproduct-update-sub-form.component.html',
  styleUrls: ['./packingproduct-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PackingproductUpdateSubFormComponent),
      multi: true
    }, {
...
export class PackingproductUpdateSubFormComponent extends AbstractSubFormComponent<Packingproduct> implements OnInit{
