...
export class PackingDetailComponent extends AbstractComponent implements OnInit {
  ...
  async delete(): Promise<void>{
    const dialogRef = this.dialog.open(DeleteConfirmDialogComponent, {
      width: '300px',
      data: {message: this.packing.code}
    });
    ...
    dialogRef.afterClosed().subscribe( async result => {
      ...
      try {
        await this.packingService.delete(this.selectedId);
