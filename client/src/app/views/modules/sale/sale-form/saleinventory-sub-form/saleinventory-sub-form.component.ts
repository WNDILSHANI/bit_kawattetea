...
@Component({
  selector: 'app-saleinventory-sub-form',
  templateUrl: './saleinventory-sub-form.component.html',
  styleUrls: ['./saleinventory-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SaleinventorySubFormComponent),
      multi: true
    }, {
...
export class SaleinventorySubFormComponent extends AbstractSubFormComponent<Saleinventory> implements OnInit{
